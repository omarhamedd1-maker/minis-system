...
export const NOT_IN_PROFIT: ExcludedCategory[] = [
  ...
  {
    // عمر أكّد ١٧ سبتمبر: تكلفة «الاسكرينات» (2 SEC) متسجّلة على المنتج.
    // ⚠️ ده كمان النوع الافتراضي لدفعة المورد — ودفعة المورد = بضاعة
    // تكلفتها على المنتج، فنفس الحكم. (يوم القرار: صفر دفعة مورد عليه)
    category: "بضاعة",
    why: "تكلفتها محسوبة على المنتج وقت البيع",
  },
  {
