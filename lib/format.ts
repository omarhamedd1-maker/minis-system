...
export function collectionState(order: {
  ...
  // "مع بوسطة" مش "وصلت" — العميل دفع، بس بوسطة بتقعد بالفلوس يوم أو أكتر
  // وبتحوّل بدفعات. الحالة القديمة كانت بتقول "وصلت" وهي لسه في محفظتهم.
  //
  // ⚠️ **ومفيش "وصلت" تلقائي**: مسار محفظة بوسطة مقفول علينا (بيرجّع ٤٠١ —
  // صلاحية المفتاح مابتشملش المحفظة)، فمفيش طريقة نعرف التحويل. وعمر مش
  // عايز زرار يدوي، فبنقف عند الحقيقة اللي نعرفها. لو بوسطة فتحت الصلاحية
  // دي، "وصلت" تبقى تلقائية وقتها.
