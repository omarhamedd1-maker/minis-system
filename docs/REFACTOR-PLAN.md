...
> ⚠️ **المواصفة الحالية للمرحلة دي: [`docs/PHASE2-RESTRUCTURE.md`](PHASE2-RESTRUCTURE.md)** (١٥ سبتمبر،
> بعد مراجعة اللقطات ومراجعة الكود). **الموافق على تنفيذه: الخطوات ١ → ٥ بس.**
> الكلام اللي تحت ده الخطة القديمة — مرجع، ولو اتعارض مع المواصفة الجديدة، الجديدة هي الصح.
