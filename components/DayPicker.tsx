      ...
      {open && (
        <>
          <div
            ...
            aria-hidden="true"
          ></div>
          <div className="absolute top-full z-50 mt-2 flex w-max max-w-[calc(100vw-2rem)] flex-col gap-2 rounded-card border border-line bg-surface p-3 shadow-pop ltr:left-0 rtl:left-0">
