      ...
      <div className="rounded-xl bg-white p-4 shadow-sm sm:p-5">
        ...
        {reasons.rows.length === 0 ? (
          <p className="mt-3 text-sm text-gray-500">
            لسه مفيش سبب متسجّل. السبب بيتحط من صفحة الأوردر لما الشحنة
            ترجع — و{reasons.unknown} شحنة مستنية.
          </p>
        ) : (
          <>
            ...
            {reasons.unknown > 0 && (
              <p className="mt-3 border-t border-gray-100 pt-2 text-xs text-gray-400">
                {reasons.unknown} شحنة مااتسجّلش سببها — مش داخلة في النِّسَب
                فوق عشان الأرقام ماتبانش أدق مما هي.
              </p>
            )}
          </>
        )}
