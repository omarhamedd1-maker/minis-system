// ==========================================================================
// ⚠️ الدالة دي اتقاعدت — ٢٩ يوليو ٢٠٢٦. متعدّلش فيها.
// --------------------------------------------------------------------------
// الإرسال بقى جوّه المشروع في `lib/bosta/create.ts` وبيستخدم **مفتاح كل
// بيزنس لوحده**. الدالة دي لسه منشورة في لوحة سوبابيز كضمان أسبوع بس
// محدش بيناديها — الشاشات كلها بتنادي الكود الجديد.
//
// اتقارنوا على ٢٥ أوردر حقيقي في وضع التجربة: ٢٤ مطابقة تمامًا، والفرق
// الوحيد مقصود — أوردر ١٣٦٥ ملوش منتجات، الدالة دي كانت هتبعت شحنة فاضية
// بتحصيل صفر والجديدة بترفض.
//
// بعد أسبوع تشغيل من غير مشاكل: امسح الدالة من لوحة سوبابيز وامسح الملف ده.
// ==========================================================================
//
// (التوثيق القديم للرجوع)
