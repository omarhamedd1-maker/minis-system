// ==========================================================================
// الدالة: bosta-sync   ← ده الاسم اللي هتلاقيه في لوحة Supabase
// (اللينك بتاعها بيبقى /functions/v1/bright-endpoint — الاسم ده للرابط بس،
//  متدوّرش عليه في القايمة، دوّر على bosta-sync)
//
