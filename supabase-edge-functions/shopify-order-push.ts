// ==========================================================================
// الدالة القديمة — منسوخة من لوحة سوبابيز زي ما هي بالظبط، من غير أي تعديل
// --------------------------------------------------------------------------
// **الملف ده مرجع مش كود شغّال.** محفوظ هنا عشان يفضل قدامنا وإحنا بنكتب
// النسخة الجديدة جوّه المشروع، وعشان المقارنة تبقى ضد نص حقيقي مش ذاكرة.
// نفس مكان دوال بوسطة القديمة.
//
// اتنسخ ٣٠ يوليو ٢٠٢٦.
//
// ملاحظات وإحنا بنقرا (التفاصيل في lib/shopify/order-push.ts):
//  - `dry=1` بيرجع الخطة من غير ما يكتب حاجة — بيقف قبل orderEditBegin.
//  - `cantRaise` مش داخلة في عدّاد التغييرات، فالدالة بترجّع "مفيش فرق"
//    وفيه فرق. ده مصدر الشكوى الأساسي.
//  - `LABEL` هو اللي بيخلّي الخصم مايتراكمش: بنشيل خصمنا القديم بالاسم
//    قبل ما نحط الجديد. دي الحتة اللي خدت محاولات كتير — متتلمسش.
// ==========================================================================
