...
-- المرتجع رجع المخزن؟
-- --------------------------------------------------------------------------
-- ⚠️⚠️ **الخانة دي هي اللي بتمنع الرجوع مرتين.** من غيرها دوستين على الزرار
-- بيزوّدوا الكمية مرتين — والرقم الغلط بيخلّيك تبيع حاجة مش موجودة، وده أوحش
-- من إنها ماترجعش أصلًا.
-- ==========================================================================
