...
-- ==========================================================================
-- دلوقتي القيمة الافتراضية ثابتة على "مينيز". ده تمام وإحنا بيزنس واحد،
-- بس أول ما ييجي بيزنس تاني، أي صف جديد هيتنسبله مينيز غلط.
--
...
-- بمفتاح الأدمن من دالة مجدولة مثلاً) بترجّع مينيز.
