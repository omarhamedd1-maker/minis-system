...
-- ==========================================================================
-- الخطوة دي **مابتغيّرش أي سلوك**. كل الداتا الموجودة بتتنسب لبيزنس مينيز،
...
-- بيزنس مينيز نفسه — أول بيزنس في السيستم
insert into tenants (id, name)
values ('00000000-0000-0000-0000-000000000001', 'مينيز')
on conflict (id) do nothing;


-- ===== ٢) خانة رقم البيزنس على كل جدول =====
-- القيمة الافتراضية = مينيز، عشان الداتا الموجودة والصفوف الجديدة تشتغل
...
--   order by table_name;
--
-- والمفروض كل الداتا القديمة بقت منسوبة لمينيز:
--
