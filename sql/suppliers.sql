...
--
-- شغل بالأجل: الفاتورة بتزوّد اللي عليك بس (مش مصروف ومش حركة خزنة)،
-- والدفعة هي اللي بتتسجّل مصروف (related_expense_id) وبتتخصم من الخزنة.
-- لو مسحت أي حركة، بيتمسح أثرها كله.
